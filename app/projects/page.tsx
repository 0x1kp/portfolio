...
export const metadata = {
  title: "Projects | David Ukeje",
  description:
    "Security engineering projects, homelab builds, detection rules, and cloud security tools by David Ukeje.",
};
...
> = {
  security: {
    ...
    description: "Threat hunting, malware analysis, and security tooling",
  },
  cloud: {
    label: "Cloud Security",
    description: "AWS, GCP, and multi-cloud security projects",
  },
  homelab: {
    label: "Homelab",
    description: "Building enterprise infrastructure for learning and testing",
  },
  detection: {
    label: "Detection Engineering",
    description: "SIEM, detection rules, and log analysis",
  },
  research: {
    label: "Research",
    description: "Academic papers and security research",
  },
};
      ...
      <section id="projects-hero" aria-labelledby="projects-title">
        <div className="w-full space-y-4">
          ...
          <p className="max-w-[600px] md:text-xl text-muted-foreground">
            A collection of security engineering projects, homelab builds,
            detection rules, and open-source contributions.
          </p>
        </div>
      </section>

      {/* All Projects Grid */}
      <section id="all-projects" className="space-y-12">
